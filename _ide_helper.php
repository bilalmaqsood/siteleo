...
namespace ElForastero\Transliterate { 
    ...
    class TransliterationFacade {
         ...
         * @static 
         */ 
        public static function make($string, $params = array())
        {
            return \ElForastero\Transliterate\Transliteration::make($string, $params);
        }
        ...
        {
            return \ElForastero\Transliterate\Transliteration::getCommonMap();
        }
        ...
        {
            return \ElForastero\Transliterate\Transliteration::getGost2000Map();
        }
...
namespace  { 
    ...
    class Transliterate extends \ElForastero\Transliterate\TransliterationFacade {}
